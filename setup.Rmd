...
https://github.com/GCJulien2/mon_livre.git

https://github.com/GCJulien2/dash.git
...
9. Type `git remote add CHOIX_NOM 
git remote add mon_livre https://github.com/GCJulien2/mon_livre.git
...
15. It should say "Your site is ready to be published at
https://username.github.io/mon_livre/" — click the link to see but error page
